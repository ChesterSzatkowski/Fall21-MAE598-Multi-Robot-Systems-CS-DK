...
% define robot parameters; wheel radius = 0.05m, track width = 0.25m, and
% inputs are speed and heading angle
robot = differentialDriveKinematics("TrackWidth", 0.25, "VehicleInputs", "VehicleSpeedHeadingRate");
